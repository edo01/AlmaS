...
public class FractionCollectionTests {
	...
	public static void main(String[] args) {
		...
		res = c1.mul(c2);
		assert(new Frazione(1, 1).equals(res.get(0)));
		assert(new Frazione(1, 4).equals(res.get(1)));
		assert(new Frazione(1, 9).equals(res.get(2)));
		assert(new Frazione(1, 16).equals(res.get(3)));
		assert(new Frazione(1, 25).equals(res.get(4)));
	}
