package fondt2.tlc.tests.algorithms;
...
private PhonePlan plane;
	...
	public void setUp()
	{
		...
		Band[] bands = new Band[] {
				...
				new Band(LocalTime.of(10, 0), LocalTime.of(18, 00).minusNanos(1), workWeek, 20),
				new Band(LocalTime.of(8, 0), LocalTime.of(10, 00).minusNanos(1), workWeek, 20),
