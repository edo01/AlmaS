...
public class MediaView {
	...
	public void addMedia() {
		...
		if (option > 0) {
			...
			if (e == null) {
				System.out.println("Si � verificato un errore nella creazione del nuovo media");
				return;
			}
			...
			if (ok)
				...
				System.out.println("Si � verificato un errore nell'inserimento nella collezione");
		}
	}
	...
	public boolean save(String path) {
		return myMediaController.saveAll(path);
	}
	
	public void readFromFile(String path) {
		print(myMediaController.readAll(path));
	}
}
