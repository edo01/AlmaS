...
public class MediaCollection {
	...
	public MediaCollection sorted(Comparator<Media> c) {
		Media[] media_copy = this.innerContainer.clone();
		Arrays.sort(media_copy, c);
		return new MediaCollection(media_copy);
	}
	
	public void sortWith(Comparator<Media> c) {
		Arrays.sort(this.innerContainer, c);
	}
}